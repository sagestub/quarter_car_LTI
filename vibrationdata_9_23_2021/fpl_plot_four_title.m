%
%   fpl_plot_four_title.m  ver 1.6  by Tom Irvine
%
function[fig_num]=fpl_plot_four_title(fig_num,n_type,f1,dB1,f2,dB2,f3,dB3,f4,dB4,leg1,leg2,leg3,leg4,t_string)
%
...
disp(' ');
out1=sprintf('Overall Fluctuating Pressure Levels  %s \n Ref: 20 micro Pa',t_string);
disp(out1)
...
grid on;
if(n_type==1)
    disp(' One-Third Octave Fluctuating Pressure Level  Ref: 20 micro Pa ');
else
    disp(' Full Octave Fluctuating Pressure Level  Ref: 20 micro Pa ');    
end    


out1=sprintf('Fluctuating Pressure Level  %s \n Ref: 20 micro Pa',t_string);
title(out1);

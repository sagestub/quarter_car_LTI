function varargout = clf_L_Plate(varargin)
% CLF_L_PLATE MATLAB code for clf_L_Plate.fig
%      CLF_L_PLATE, by itself, creates a new CLF_L_PLATE or raises the existing
%      singleton*.
%
%      H = CLF_L_PLATE returns the handle to a new CLF_L_PLATE or the handle to
%      the existing singleton*.
%
%      CLF_L_PLATE('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in CLF_L_PLATE.M with the given input arguments.
%
%      CLF_L_PLATE('Property','Value',...) creates a new CLF_L_PLATE or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before clf_L_Plate_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to clf_L_Plate_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help clf_L_Plate

% Last Modified by GUIDE v2.5 18-Dec-2015 16:27:28

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @clf_L_Plate_OpeningFcn, ...
                   'gui_OutputFcn',  @clf_L_Plate_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before clf_L_Plate is made visible.
function clf_L_Plate_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to clf_L_Plate (see VARARGIN)

% Choose default command line output for clf_L_Plate
...
% UIWAIT makes clf_L_Plate wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = clf_L_Plate_OutputFcn(hObject, eventdata, handles) 
...
[clf_12,clf_21]=L_plate_clf_function(f,em_1,em_2,mu_1,mu_2,...
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%    
    ...
    figure(1);
    plot(f,clf_12,f,clf_21);
    legend('clf 12','clf 21');
    
    title('L-Plate Coupling Loss Factors');
    ...
    for i=1:length(f)
        out1=sprintf(' %6.0f  %8.4g  %8.4g ',f(i),clf_12(i),clf_21(i));
        disp(out1);
    end

...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%    
%
	disp(' damped_sine_syn.m    ver 3.3    January 6, 2011 ');
	disp(' by Tom Irvine');
...
%		disp('  Calculating damped sine parameters.');
		[amp,phase,delay,dampt,sss]=DSS_sintime(ns,dt,dur,tpi,ia,iamax,ra,omega,last,syn_error,best_amp,best_phase,best_delay,best_dampt);
%

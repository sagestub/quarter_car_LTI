function varargout = fairing_payload_simple_single(varargin)
% FAIRING_PAYLOAD_SIMPLE_SINGLE MATLAB code for fairing_payload_simple_single.fig
%      FAIRING_PAYLOAD_SIMPLE_SINGLE, by itself, creates a new FAIRING_PAYLOAD_SIMPLE_SINGLE or raises the existing
%      singleton*.
%
%      H = FAIRING_PAYLOAD_SIMPLE_SINGLE returns the handle to a new FAIRING_PAYLOAD_SIMPLE_SINGLE or the handle to
%      the existing singleton*.
%
%      FAIRING_PAYLOAD_SIMPLE_SINGLE('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in FAIRING_PAYLOAD_SIMPLE_SINGLE.M with the given input arguments.
%
%      FAIRING_PAYLOAD_SIMPLE_SINGLE('Property','Value',...) creates a new FAIRING_PAYLOAD_SIMPLE_SINGLE or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before fairing_payload_simple_single_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to fairing_payload_simple_single_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help fairing_payload_simple_single

% Last Modified by GUIDE v2.5 10-May-2016 16:23:07

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @fairing_payload_simple_single_OpeningFcn, ...
                   'gui_OutputFcn',  @fairing_payload_simple_single_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before fairing_payload_simple_single is made visible.
function fairing_payload_simple_single_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to fairing_payload_simple_single (see VARARGIN)

% Choose default command line output for fairing_payload_simple_single
...
axes(handles.axes1);
bg = imread('three_subsystems_b.jpg');
info.Width=349;
info.Height=217;
...
set(handles.axes1, ...
    'Visible', 'off', ...
    'Units', 'pixels', ...
    'Position', [30 180 info.Width info.Height]);
axis off; 
...
% UIWAIT makes fairing_payload_simple_single wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = fairing_payload_simple_single_OutputFcn(hObject, eventdata, handles) 

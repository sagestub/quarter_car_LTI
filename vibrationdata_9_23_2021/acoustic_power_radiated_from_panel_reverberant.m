function varargout = acoustic_power_radiated_from_panel_reverberant(varargin)
% ACOUSTIC_POWER_RADIATED_FROM_PANEL_REVERBERANT MATLAB code for acoustic_power_radiated_from_panel_reverberant.fig
%      ACOUSTIC_POWER_RADIATED_FROM_PANEL_REVERBERANT, by itself, creates a new ACOUSTIC_POWER_RADIATED_FROM_PANEL_REVERBERANT or raises the existing
%      singleton*.
%
%      H = ACOUSTIC_POWER_RADIATED_FROM_PANEL_REVERBERANT returns the handle to a new ACOUSTIC_POWER_RADIATED_FROM_PANEL_REVERBERANT or the handle to
%      the existing singleton*.
%
%      ACOUSTIC_POWER_RADIATED_FROM_PANEL_REVERBERANT('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in ACOUSTIC_POWER_RADIATED_FROM_PANEL_REVERBERANT.M with the given input arguments.
%
%      ACOUSTIC_POWER_RADIATED_FROM_PANEL_REVERBERANT('Property','Value',...) creates a new ACOUSTIC_POWER_RADIATED_FROM_PANEL_REVERBERANT or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before acoustic_power_radiated_from_panel_reverberant_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to acoustic_power_radiated_from_panel_reverberant_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help acoustic_power_radiated_from_panel_reverberant

% Last Modified by GUIDE v2.5 07-Jan-2016 13:34:47

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @acoustic_power_radiated_from_panel_reverberant_OpeningFcn, ...
                   'gui_OutputFcn',  @acoustic_power_radiated_from_panel_reverberant_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before acoustic_power_radiated_from_panel_reverberant is made visible.
function acoustic_power_radiated_from_panel_reverberant_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to acoustic_power_radiated_from_panel_reverberant (see VARARGIN)

% Choose default command line output for acoustic_power_radiated_from_panel_reverberant
...
% UIWAIT makes acoustic_power_radiated_from_panel_reverberant wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = acoustic_power_radiated_from_panel_reverberant_OutputFcn(hObject, eventdata, handles) 
...
delete(acoustic_power_radiated_from_panel_reverberant);
...
% p_rad=rho_g*fcr*force^2*rad_eff/(8*c*freq*rho_s^2*lf);   free field

p_rad=(rho_g*c)*(L*W)*v1^2*rad_eff;

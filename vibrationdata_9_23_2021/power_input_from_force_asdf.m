function varargout = power_input_from_force_asdf(varargin)
% POWER_INPUT_FROM_FORCE_ASDF MATLAB code for power_input_from_force_asdf.fig
%      POWER_INPUT_FROM_FORCE_ASDF, by itself, creates a new POWER_INPUT_FROM_FORCE_ASDF or raises the existing
%      singleton*.
%
%      H = POWER_INPUT_FROM_FORCE_ASDF returns the handle to a new POWER_INPUT_FROM_FORCE_ASDF or the handle to
%      the existing singleton*.
%
%      POWER_INPUT_FROM_FORCE_ASDF('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in POWER_INPUT_FROM_FORCE_ASDF.M with the given input arguments.
%
%      POWER_INPUT_FROM_FORCE_ASDF('Property','Value',...) creates a new POWER_INPUT_FROM_FORCE_ASDF or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before power_input_from_force_asdf_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to power_input_from_force_asdf_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help power_input_from_force_asdf

% Last Modified by GUIDE v2.5 11-Dec-2015 11:15:53

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @power_input_from_force_asdf_OpeningFcn, ...
                   'gui_OutputFcn',  @power_input_from_force_asdf_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before power_input_from_force_asdf is made visible.
function power_input_from_force_asdf_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to power_input_from_force_asdf (see VARARGIN)

% Choose default command line output for power_input_from_force_asdf
...
% UIWAIT makes power_input_from_force_asdf wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = power_input_from_force_asdf_OutputFcn(hObject, eventdata, handles) 

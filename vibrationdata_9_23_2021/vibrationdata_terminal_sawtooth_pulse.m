%
%  vibrationdata_terminal_sawtooth_pulse.m  ver 1.0  by Tom Irvine
%
function[a_srs,pv_srs,rd_srs,base_th,a_th,rd_th]=...
             vibrationdata_terminal_sawtooth_pulse(nat,amp,dur,fn,Q,resp_dur,iunit)
%
damp=1/(2*Q);
%
%
...
%
        [acc,rd,TT,yb]=...
            vb_terminal_sawtooth_time_calc(rd_initial,rv_initial,domegan,...
            omegad,damp,omega,omegan,omegan2,nt,dt,dur,amp);
%
        acc=fix_size(acc);
        rd=fix_size(rd);
        TT=fix_size(TT);

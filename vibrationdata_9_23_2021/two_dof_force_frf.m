...
%
hold on;
plot(real(HR1),imag(HR1));
plot(real(HR11),imag(HR11),'x','MarkerSize',12);
plot(real(HR12),imag(HR12),'+','MarkerSize',12);
title('Nyquist FRF of Receptance at Mass 1');
ylabel('Imag');
xlabel('Real');
grid on;
hold off;
...
%
hold on;
plot(real(HR2),imag(HR2));
plot(real(HR21),imag(HR21),'x','MarkerSize',12);
plot(real(HR22),imag(HR22),'+','MarkerSize',12);
title('Nyquist FRF of Receptance at Mass 2');
ylabel('Imag');
xlabel('Real');
grid on;
hold off;

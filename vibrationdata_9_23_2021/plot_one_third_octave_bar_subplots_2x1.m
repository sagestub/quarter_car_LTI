function varargout = plot_one_third_octave_bar_subplots_2x1(varargin)
% PLOT_ONE_THIRD_OCTAVE_BAR_SUBPLOTS_2X1 MATLAB code for plot_one_third_octave_bar_subplots_2x1.fig
%      PLOT_ONE_THIRD_OCTAVE_BAR_SUBPLOTS_2X1, by itself, creates a new PLOT_ONE_THIRD_OCTAVE_BAR_SUBPLOTS_2X1 or raises the existing
%      singleton*.
%
%      H = PLOT_ONE_THIRD_OCTAVE_BAR_SUBPLOTS_2X1 returns the handle to a new PLOT_ONE_THIRD_OCTAVE_BAR_SUBPLOTS_2X1 or the handle to
%      the existing singleton*.
%
%      PLOT_ONE_THIRD_OCTAVE_BAR_SUBPLOTS_2X1('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in PLOT_ONE_THIRD_OCTAVE_BAR_SUBPLOTS_2X1.M with the given input arguments.
%
%      PLOT_ONE_THIRD_OCTAVE_BAR_SUBPLOTS_2X1('Property','Value',...) creates a new PLOT_ONE_THIRD_OCTAVE_BAR_SUBPLOTS_2X1 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before plot_one_third_octave_bar_subplots_2x1_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to plot_one_third_octave_bar_subplots_2x1_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help plot_one_third_octave_bar_subplots_2x1

% Last Modified by GUIDE v2.5 27-Sep-2018 15:30:26

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @plot_one_third_octave_bar_subplots_2x1_OpeningFcn, ...
                   'gui_OutputFcn',  @plot_one_third_octave_bar_subplots_2x1_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before plot_one_third_octave_bar_subplots_2x1 is made visible.
function plot_one_third_octave_bar_subplots_2x1_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to plot_one_third_octave_bar_subplots_2x1 (see VARARGIN)

% Choose default command line output for plot_one_third_octave_bar_subplots_2x1
...
% UIWAIT makes plot_one_third_octave_bar_subplots_2x1 wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = plot_one_third_octave_bar_subplots_2x1_OutputFcn(hObject, eventdata, handles) 
...
xmin=min([  THM1(1,1)  THM2(1,1)   ]);
xmax=max([  THM1(end,1)  THM2(end,1) ]);
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
delete(plot_one_third_octave_bar_subplots_2x1);

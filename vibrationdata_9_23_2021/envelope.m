disp(' ');	
disp(' envelope.m   ver 1.8   May 5, 2014 ');
disp(' ');	
disp(' by Tom Irvine ');
...
%	   
            ...
            [f_sam,apsd_sam]=env_generate_sample_psd(n_ref,nbreak,f_ref,ik,slopec,initial,final,f1,f2);            
%
	   else
%
			[f_sam,apsd_sam]=env_generate_sample_psd2(n_ref,nbreak,f_ref,xf,xapsd,slopec,initial,final,ik,f1,f2);
%
       end
%

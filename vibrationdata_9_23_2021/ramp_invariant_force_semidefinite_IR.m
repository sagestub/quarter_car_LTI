%
%  ramp_invariant_force_semidefinite_IR.m  ver 1.1  by Tom Irvine
%

function[x,v,a,nx,nv,na]=...
                 ramp_invariant_force_semidefinite_IR(ModeShapes,F,ndof,sys_dof,omegan,dampv,dt,Ge,num_modes)
...
%
    ...
    term=( (na(:,j)/omegan(j)^2) + na(:,j)*(2*dampv(j)/omegan(j)) );

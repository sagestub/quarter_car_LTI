%
%  werror22.m  ver 1.1  by Tom Irvine
%
function[wavelet_table_add,amp,emax1,emax2,ferr,serr]...
         =werror22(wavelet_table_add,mflag,fn,xmin,xmax,srs_spec,...
                       last_srs,last_wavelet,rrr,amp,emax1,emax2,ijk) 
%
	em1=0.;
	ew1=0.;
    emax1=1.*emax1;

function varargout = SEA_equiv_aco_power_fairing_ex(varargin)
% SEA_EQUIV_ACO_POWER_FAIRING_EX MATLAB code for SEA_equiv_aco_power_fairing_ex.fig
%      SEA_EQUIV_ACO_POWER_FAIRING_EX, by itself, creates a new SEA_EQUIV_ACO_POWER_FAIRING_EX or raises the existing
%      singleton*.
%
%      H = SEA_EQUIV_ACO_POWER_FAIRING_EX returns the handle to a new SEA_EQUIV_ACO_POWER_FAIRING_EX or the handle to
%      the existing singleton*.
%
%      SEA_EQUIV_ACO_POWER_FAIRING_EX('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in SEA_EQUIV_ACO_POWER_FAIRING_EX.M with the given input arguments.
%
%      SEA_EQUIV_ACO_POWER_FAIRING_EX('Property','Value',...) creates a new SEA_EQUIV_ACO_POWER_FAIRING_EX or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before SEA_equiv_aco_power_fairing_ex_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to SEA_equiv_aco_power_fairing_ex_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help SEA_equiv_aco_power_fairing_ex

% Last Modified by GUIDE v2.5 17-Feb-2017 15:18:20

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @SEA_equiv_aco_power_fairing_ex_OpeningFcn, ...
                   'gui_OutputFcn',  @SEA_equiv_aco_power_fairing_ex_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before SEA_equiv_aco_power_fairing_ex is made visible.
function SEA_equiv_aco_power_fairing_ex_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to SEA_equiv_aco_power_fairing_ex (see VARARGIN)

% Choose default command line output for SEA_equiv_aco_power_fairing_ex
handles.output = hObject;


dlf=getappdata(0,'fairing_dlf');
diameter=getappdata(0,'fairing_diam');
thick=getappdata(0,'fairing_thick');
L=getappdata(0,'fairing_L');  
ng=getappdata(0,'fairing_ng');
nd=getappdata(0,'fairing_nd');
c=getappdata(0,'fairing_c');
gas_md=getappdata(0,'fairing_gas_md');

imat=getappdata(0,'fairing_homogeneous_shell_mat');
em=getappdata(0,'fairing_homogeneous_shell_em');
md=getappdata(0,'fairing_homogeneous_shell_rho');
mu=getappdata(0,'fairing_homogeneous_shell_mu');
...
% UIWAIT makes SEA_equiv_aco_power_fairing_ex wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = SEA_equiv_aco_power_fairing_ex_OutputFcn(hObject, eventdata, handles) 
...
delete(SEA_equiv_aco_power_fairing_ex);
...
setappdata(0,'fairing_homogeneous_shell_mat',imat);

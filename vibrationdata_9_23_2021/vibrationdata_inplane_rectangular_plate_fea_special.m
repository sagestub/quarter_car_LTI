function varargout = vibrationdata_inplane_rectangular_plate_fea_special(varargin)
% VIBRATIONDATA_INPLANE_RECTANGULAR_PLATE_FEA_SPECIAL MATLAB code for vibrationdata_inplane_rectangular_plate_fea_special.fig
%      VIBRATIONDATA_INPLANE_RECTANGULAR_PLATE_FEA_SPECIAL, by itself, creates a new VIBRATIONDATA_INPLANE_RECTANGULAR_PLATE_FEA_SPECIAL or raises the existing
%      singleton*.
%
%      H = VIBRATIONDATA_INPLANE_RECTANGULAR_PLATE_FEA_SPECIAL returns the handle to a new VIBRATIONDATA_INPLANE_RECTANGULAR_PLATE_FEA_SPECIAL or the handle to
%      the existing singleton*.
%
%      VIBRATIONDATA_INPLANE_RECTANGULAR_PLATE_FEA_SPECIAL('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in VIBRATIONDATA_INPLANE_RECTANGULAR_PLATE_FEA_SPECIAL.M with the given input arguments.
%
%      VIBRATIONDATA_INPLANE_RECTANGULAR_PLATE_FEA_SPECIAL('Property','Value',...) creates a new VIBRATIONDATA_INPLANE_RECTANGULAR_PLATE_FEA_SPECIAL or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before vibrationdata_inplane_rectangular_plate_fea_special_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to vibrationdata_inplane_rectangular_plate_fea_special_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help vibrationdata_inplane_rectangular_plate_fea_special

% Last Modified by GUIDE v2.5 16-Feb-2016 14:52:48

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @vibrationdata_inplane_rectangular_plate_fea_special_OpeningFcn, ...
                   'gui_OutputFcn',  @vibrationdata_inplane_rectangular_plate_fea_special_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before vibrationdata_inplane_rectangular_plate_fea_special is made visible.
function vibrationdata_inplane_rectangular_plate_fea_special_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to vibrationdata_inplane_rectangular_plate_fea_special (see VARARGIN)

% Choose default command line output for vibrationdata_inplane_rectangular_plate_fea_special
...
% UIWAIT makes vibrationdata_inplane_rectangular_plate_fea_special wait for user response (see UIRESUME)
...
function varargout = vibrationdata_inplane_rectangular_plate_fea_special_OutputFcn(hObject, eventdata, handles) 
...
%%%
    ...
    ss_dx=sprintf('%s_dx',sname);    
    out1=sprintf('%s_dx=dx;',ss);
    eval(out1);
    
    ss_dy=sprintf('%s_dy',sname);    
    out1=sprintf('%s_dy=dy;',ss);
    eval(out1);
...
%%%
    ...
    save(elk,ss,ss_nx,ss_ny,ss_mass_unc,ss_stiff_unc,ss_node_matrix,...
         ...
         ss_damp_Q,ss_damp_ratio,ss_total_mass,ss_dx,ss_dy);

function varargout = SEA_four_subsystems_3(varargin)
% SEA_FOUR_SUBSYSTEMS_3 MATLAB code for SEA_four_subsystems_3.fig
%      SEA_FOUR_SUBSYSTEMS_3, by itself, creates a new SEA_FOUR_SUBSYSTEMS_3 or raises the existing
%      singleton*.
%
%      H = SEA_FOUR_SUBSYSTEMS_3 returns the handle to a new SEA_FOUR_SUBSYSTEMS_3 or the handle to
%      the existing singleton*.
%
%      SEA_FOUR_SUBSYSTEMS_3('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in SEA_FOUR_SUBSYSTEMS_3.M with the given input arguments.
%
%      SEA_FOUR_SUBSYSTEMS_3('Property','Value',...) creates a new SEA_FOUR_SUBSYSTEMS_3 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before SEA_four_subsystems_3_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to SEA_four_subsystems_3_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help SEA_four_subsystems_3

% Last Modified by GUIDE v2.5 06-Jan-2016 13:04:44

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @SEA_four_subsystems_3_OpeningFcn, ...
                   'gui_OutputFcn',  @SEA_four_subsystems_3_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before SEA_four_subsystems_3 is made visible.
function SEA_four_subsystems_3_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to SEA_four_subsystems_3 (see VARARGIN)

% Choose default command line output for SEA_four_subsystems_3
...
data_s{12,1} = 'Coupling Loss Factor 14'; 
data_s{13,1} = 'Coupling Loss Factor 41'; 
...
% UIWAIT makes SEA_four_subsystems_3 wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = SEA_four_subsystems_3_OutputFcn(hObject, eventdata, handles) 

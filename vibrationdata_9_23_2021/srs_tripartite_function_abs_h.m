%
%   srs_tripartite_function_abs_h.m   ver 2.5   by Tom Irvine
%
function[fig_num,h]=srs_tripartite_function_abs_h(iunit,fig_num,fn,pv_srs,Q)
%
%    
    n=length(fn);
%

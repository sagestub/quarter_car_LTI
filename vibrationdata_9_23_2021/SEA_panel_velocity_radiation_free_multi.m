function varargout = SEA_panel_velocity_radiation_free_multi(varargin)
% SEA_PANEL_VELOCITY_RADIATION_FREE_MULTI MATLAB code for SEA_panel_velocity_radiation_free_multi.fig
%      SEA_PANEL_VELOCITY_RADIATION_FREE_MULTI, by itself, creates a new SEA_PANEL_VELOCITY_RADIATION_FREE_MULTI or raises the existing
%      singleton*.
%
%      H = SEA_PANEL_VELOCITY_RADIATION_FREE_MULTI returns the handle to a new SEA_PANEL_VELOCITY_RADIATION_FREE_MULTI or the handle to
%      the existing singleton*.
%
%      SEA_PANEL_VELOCITY_RADIATION_FREE_MULTI('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in SEA_PANEL_VELOCITY_RADIATION_FREE_MULTI.M with the given input arguments.
%
%      SEA_PANEL_VELOCITY_RADIATION_FREE_MULTI('Property','Value',...) creates a new SEA_PANEL_VELOCITY_RADIATION_FREE_MULTI or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before SEA_panel_velocity_radiation_free_multi_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to SEA_panel_velocity_radiation_free_multi_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help SEA_panel_velocity_radiation_free_multi

% Last Modified by GUIDE v2.5 15-Jan-2016 14:21:02

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @SEA_panel_velocity_radiation_free_multi_OpeningFcn, ...
                   'gui_OutputFcn',  @SEA_panel_velocity_radiation_free_multi_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before SEA_panel_velocity_radiation_free_multi is made visible.
function SEA_panel_velocity_radiation_free_multi_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to SEA_panel_velocity_radiation_free_multi (see VARARGIN)

% Choose default command line output for SEA_panel_velocity_radiation_free_multi
...
% UIWAIT makes SEA_panel_velocity_radiation_free_multi wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = SEA_panel_velocity_radiation_free_multi_OutputFcn(hObject, eventdata, handles) 
...
delete(SEA_panel_velocity_radiation_free_multi);
...
for i=1:NL
    ...
    power(i)=rho_g*c*A*rad_eff(i)*v(i)^2;
end
...
disp(' ');
disp(' Radiated Acoustic Power from Panel ');
disp(' ');

disp(' Center   Radiation     Radiated  ');
disp('  Freq    Efficiency     Power    '); 
...
for i=1:NL
    out1=sprintf('%8.4g   %8.4g   %8.4g ',fc(i),rad_eff(i),power(i));
    disp(out1);
end
...
radiated_power=[fc power];
assignin('base', 'radiated_power',radiated_power);

disp('Output array: radiated_power');
...
ppp1=radiated_power;
t_string='Radiated Acoustic Power Spectrum';
...
ppp1=[fc vo];
t_string='Spatial Average Velocity Spectrum';
...
if(iu==1)  % English   
    ...
    set(handles.text_gas_c,'String','Gas Speed of Sound (ft/sec)'); 
    set(handles.text_vu,'String','2.  Velocity (in/sec) rms');
else
    ...
    set(handles.text_gas_c,'String','Gas Speed of Sound (m/sec)');   
    set(handles.text_vu,'String','2.  Velocity (mm/sec) rms');    
end

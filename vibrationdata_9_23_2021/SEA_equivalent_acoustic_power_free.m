function varargout = SEA_equivalent_acoustic_power_free(varargin)
% SEA_EQUIVALENT_ACOUSTIC_POWER_FREE MATLAB code for SEA_equivalent_acoustic_power_free.fig
%      SEA_EQUIVALENT_ACOUSTIC_POWER_FREE, by itself, creates a new SEA_EQUIVALENT_ACOUSTIC_POWER_FREE or raises the existing
%      singleton*.
%
%      H = SEA_EQUIVALENT_ACOUSTIC_POWER_FREE returns the handle to a new SEA_EQUIVALENT_ACOUSTIC_POWER_FREE or the handle to
%      the existing singleton*.
%
%      SEA_EQUIVALENT_ACOUSTIC_POWER_FREE('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in SEA_EQUIVALENT_ACOUSTIC_POWER_FREE.M with the given input arguments.
%
%      SEA_EQUIVALENT_ACOUSTIC_POWER_FREE('Property','Value',...) creates a new SEA_EQUIVALENT_ACOUSTIC_POWER_FREE or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before SEA_equivalent_acoustic_power_free_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to SEA_equivalent_acoustic_power_free_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help SEA_equivalent_acoustic_power_free

% Last Modified by GUIDE v2.5 12-Jan-2016 12:40:37

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @SEA_equivalent_acoustic_power_free_OpeningFcn, ...
                   'gui_OutputFcn',  @SEA_equivalent_acoustic_power_free_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before SEA_equivalent_acoustic_power_free is made visible.
function SEA_equivalent_acoustic_power_free_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to SEA_equivalent_acoustic_power_free (see VARARGIN)

% Choose default command line output for SEA_equivalent_acoustic_power_free
...
% UIWAIT makes SEA_equivalent_acoustic_power_free wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = SEA_equivalent_acoustic_power_free_OutputFcn(hObject, eventdata, handles) 
...
delete(SEA_equivalent_acoustic_power_free);
...
[mph,~,~]=panel_modal_density_bc(em,mu,md,thick,L,W,freq,2);  % free

[rad_eff]=re_thin_plate_free(freq,fcr,L,W,c);

max_rad_eff=3.5;
 
if(rad_eff > max_rad_eff)
    rad_eff=max_rad_eff;
end

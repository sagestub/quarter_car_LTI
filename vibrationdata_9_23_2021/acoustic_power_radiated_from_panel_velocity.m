function varargout = acoustic_power_radiated_from_panel_velocity(varargin)
% ACOUSTIC_POWER_RADIATED_FROM_PANEL_VELOCITY MATLAB code for acoustic_power_radiated_from_panel_velocity.fig
%      ACOUSTIC_POWER_RADIATED_FROM_PANEL_VELOCITY, by itself, creates a new ACOUSTIC_POWER_RADIATED_FROM_PANEL_VELOCITY or raises the existing
%      singleton*.
%
%      H = ACOUSTIC_POWER_RADIATED_FROM_PANEL_VELOCITY returns the handle to a new ACOUSTIC_POWER_RADIATED_FROM_PANEL_VELOCITY or the handle to
%      the existing singleton*.
%
%      ACOUSTIC_POWER_RADIATED_FROM_PANEL_VELOCITY('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in ACOUSTIC_POWER_RADIATED_FROM_PANEL_VELOCITY.M with the given input arguments.
%
%      ACOUSTIC_POWER_RADIATED_FROM_PANEL_VELOCITY('Property','Value',...) creates a new ACOUSTIC_POWER_RADIATED_FROM_PANEL_VELOCITY or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before acoustic_power_radiated_from_panel_velocity_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to acoustic_power_radiated_from_panel_velocity_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help acoustic_power_radiated_from_panel_velocity

% Last Modified by GUIDE v2.5 11-Jan-2016 12:45:00

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @acoustic_power_radiated_from_panel_velocity_OpeningFcn, ...
                   'gui_OutputFcn',  @acoustic_power_radiated_from_panel_velocity_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before acoustic_power_radiated_from_panel_velocity is made visible.
function acoustic_power_radiated_from_panel_velocity_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to acoustic_power_radiated_from_panel_velocity (see VARARGIN)

% Choose default command line output for acoustic_power_radiated_from_panel_velocity
...
% UIWAIT makes acoustic_power_radiated_from_panel_velocity wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = acoustic_power_radiated_from_panel_velocity_OutputFcn(hObject, eventdata, handles) 
...
delete(acoustic_power_radiated_from_panel_velocity);

...
% Last Modified by GUIDE v2.5 01-Nov-2014 18:45:52
...
set(handles.pushbutton_response_PSD,'Visible','off');
...
%    
    ...
    ss_ss_ss_ss_plate_uniform(E,D,rho,h,a,b,mu,mass_per_area,damp,x,y,MAXF,fig_num,n_units);    
%
else
%
...
%
    ...
    fn,zzr,fig_num,P,dPdx,d2Pdx2,W,dWdy,d2Wdy2,norm,PF,damp,x,y,MAXF,n_units); 
%
end
...
set(handles.pushbutton_response_PSD,'Visible','on');

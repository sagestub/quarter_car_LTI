function varargout = coupling_loss_factors_one_system(varargin)
% COUPLING_LOSS_FACTORS_ONE_SYSTEM MATLAB code for coupling_loss_factors_one_system.fig
%      COUPLING_LOSS_FACTORS_ONE_SYSTEM, by itself, creates a new COUPLING_LOSS_FACTORS_ONE_SYSTEM or raises the existing
%      singleton*.
%
%      H = COUPLING_LOSS_FACTORS_ONE_SYSTEM returns the handle to a new COUPLING_LOSS_FACTORS_ONE_SYSTEM or the handle to
%      the existing singleton*.
%
%      COUPLING_LOSS_FACTORS_ONE_SYSTEM('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in COUPLING_LOSS_FACTORS_ONE_SYSTEM.M with the given input arguments.
%
%      COUPLING_LOSS_FACTORS_ONE_SYSTEM('Property','Value',...) creates a new COUPLING_LOSS_FACTORS_ONE_SYSTEM or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before coupling_loss_factors_one_system_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to coupling_loss_factors_one_system_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help coupling_loss_factors_one_system

% Last Modified by GUIDE v2.5 12-Oct-2016 10:27:07

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @coupling_loss_factors_one_system_OpeningFcn, ...
                   'gui_OutputFcn',  @coupling_loss_factors_one_system_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before coupling_loss_factors_one_system is made visible.
function coupling_loss_factors_one_system_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to coupling_loss_factors_one_system (see VARARGIN)

% Choose default command line output for coupling_loss_factors_one_system
...
% UIWAIT makes coupling_loss_factors_one_system wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = coupling_loss_factors_one_system_OutputFcn(hObject, eventdata, handles) 

%
%  continuous_beam_base_half_sine.m  ver 1.4  October 15, 2012
%
function[fig_num,acc_hs_resp,rd_hs_resp]=...
    continuous_beam_base_half_sine(iu,fn,damp,NT,PF,beta,...
                                             C,x,fig_num,ModeShape,sq_mass)
%        
    tpi=2*pi;
    disp(' ');

%
%  rectangular_plate_base_half_sine.m  ver 1.4  September 27, 2012
%
function[acc,rel_disp,abase,fig_num]=...
  rectangular_plate_base_half_sine(fn,damp,PF,ModeShapes,T1,T2,ngw,...
...
%
    out1=sprintf(' Acceleration  Node %d relative to Base, x=%8.4g  y=%8.4g in',...

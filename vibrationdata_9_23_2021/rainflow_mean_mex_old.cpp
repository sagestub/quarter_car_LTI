...
void rainflow_cpp(double *L,double *C,double *AverageAmp,double *MaxAmp,
                     ...
                     double *D,double *ac1,double *ac2,double *amean,
...
//    mexPrintf(" ** nlhs=%d  nrhs=%d \n",nlhs,nrhs);
    ...
    plhs[12]= mxCreateDoubleMatrix(MC, 1, mxREAL);    
...
//    mexPrintf(" Call the rainflow_cpp function \n");
    ...
    rainflow_cpp(L,C,AverageAmp,MaxAmp,MinMean,AverageMean,MaxMean,MinValley,MaxPeak,D,ac1,ac2,amean,cL,y,dchoice,exponent,num);
}

%
%  wnaccel_generic_psd_syn_correction_vel.m  ver 1.1  August 14, 2014
%
function[velox,dispx,freq,full,tim,df]=...
      wnaccel_psd_syn_correction_vel(nnt,amp,dt,spec_grms,NW,freq_spec,...
...
%
kvn=1;
[velox,dispx]=vibrationdata_disp_correction(amp,dt,kvn,freq_spec(1));
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
velox=velox*(spec_grms/std(velox));
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%

function varargout = SEA_equiv_aco_power_sandwich_fairing_ex(varargin)
% SEA_EQUIV_ACO_POWER_SANDWICH_FAIRING_EX MATLAB code for SEA_equiv_aco_power_sandwich_fairing_ex.fig
%      SEA_EQUIV_ACO_POWER_SANDWICH_FAIRING_EX, by itself, creates a new SEA_EQUIV_ACO_POWER_SANDWICH_FAIRING_EX or raises the existing
%      singleton*.
%
%      H = SEA_EQUIV_ACO_POWER_SANDWICH_FAIRING_EX returns the handle to a new SEA_EQUIV_ACO_POWER_SANDWICH_FAIRING_EX or the handle to
%      the existing singleton*.
%
%      SEA_EQUIV_ACO_POWER_SANDWICH_FAIRING_EX('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in SEA_EQUIV_ACO_POWER_SANDWICH_FAIRING_EX.M with the given input arguments.
%
%      SEA_EQUIV_ACO_POWER_SANDWICH_FAIRING_EX('Property','Value',...) creates a new SEA_EQUIV_ACO_POWER_SANDWICH_FAIRING_EX or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before SEA_equiv_aco_power_sandwich_fairing_ex_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to SEA_equiv_aco_power_sandwich_fairing_ex_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help SEA_equiv_aco_power_sandwich_fairing_ex

% Last Modified by GUIDE v2.5 17-Feb-2017 16:16:39

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @SEA_equiv_aco_power_sandwich_fairing_ex_OpeningFcn, ...
                   'gui_OutputFcn',  @SEA_equiv_aco_power_sandwich_fairing_ex_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before SEA_equiv_aco_power_sandwich_fairing_ex is made visible.
function SEA_equiv_aco_power_sandwich_fairing_ex_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to SEA_equiv_aco_power_sandwich_fairing_ex (see VARARGIN)

% Choose default command line output for SEA_equiv_aco_power_sandwich_fairing_ex
handles.output = hObject;


ng=getappdata(0,'fairing_ng');

nd=getappdata(0,'fairing_nd');



imat=getappdata(0,'fairing_honeycomb_shell_mat');
bc=getappdata(0,'fairing_honeycomb_shell_bc');
nfa=getappdata(0,'fairing_honeycomb_shell_nfa');


dlf=getappdata(0,'fairing_dlf');


diameter=getappdata(0,'fairing_diam');

L=getappdata(0,'fairing_L');

E=getappdata(0,'fairing_honeycomb_shell_em');
rho_f=getappdata(0,'fairing_honeycomb_shell_md_f');
mu=getappdata(0,'fairing_honeycomb_shell_mu');
tf=getappdata(0,'fairing_honeycomb_shell_thick_f');
G=getappdata(0,'fairing_honeycomb_shell_G');
rho_c=getappdata(0,'fairing_honeycomb_shell_md_c');
hc=getappdata(0,'fairing_honeycomb_shell_thick_c');
 
gas_c=getappdata(0,'fairing_c');
gas_md=getappdata(0,'fairing_gas_md');
...
if(isempty(nfa)==0)
    if(nfa>=1 && nfa <=2)
        set(handles.listbox_fairing_assembly,'Value',nfa);
    else
        set(handles.listbox_fairing_assembly,'Value',1);        
    end
end
...
% UIWAIT makes SEA_equiv_aco_power_sandwich_fairing_ex wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = SEA_equiv_aco_power_sandwich_fairing_ex_OutputFcn(hObject, eventdata, handles) 
...
delete(SEA_equiv_aco_power_sandwich_fairing_ex);
...
setappdata(0,'fairing_ng',ng);
setappdata(0,'fairing_nd',nd);

imat=get(handles.listbox_material,'Value');
setappdata(0,'fairing_honeycomb_shell_mat',imat);

bc=get(handles.listbox_bc,'Value');
nfa=get(handles.listbox_fairing_assembly,'Value');

setappdata(0,'fairing_honeycomb_shell_mat',imat);
setappdata(0,'fairing_honeycomb_shell_bc',bc);
setappdata(0,'fairing_honeycomb_shell_nfa',nfa);
...
setappdata(0,'fairing_honeycomb_shell_thick_f',tf);

setappdata(0,'fairing_honeycomb_shell_G',G);
setappdata(0,'fairing_honeycomb_shell_md_c',rhoc);
setappdata(0,'fairing_honeycomb_shell_thick_c',hc);
...
setappdata(0,'fairing_honeycomb_shell_em',E);
setappdata(0,'fairing_honeycomb_shell_md_f',rhof);
setappdata(0,'fairing_honeycomb_shell_mu',mu);
setappdata(0,'fairing_honeycomb_shell_thick_f',tf);
setappdata(0,'fairing_honeycomb_shell_G',G);
setappdata(0,'fairing_honeycomb_shell_md_c',rhoc);
setappdata(0,'fairing_honeycomb_shell_thick_c',hc);
...
setappdata(0,'fairing_fring',fring);     
setappdata(0,'fairing_fcr',fcr); 
...
[rad_eff,mph,fstart_rad]=...
   re_sandwich_cylinder_engine_alt_dlf(D,K,v,diam,L,mpa,bc,mmax,nmax,gas_c,fcr,fring,fc,dlf);

setappdata(0,'fstart_rad',fstart_rad);
...
setappdata(0,'fairing_modal_density',mph);
...
setappdata(0,'fairing_area',area);

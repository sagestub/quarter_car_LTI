%
%   Franken_function_alt_grms_add_mass_add_mass.m  ver 1.0  by Tom Irvine
%

function[psd,grms,grmsb]=Franken_function_alt_grms_add_mass(stationdiam_ft,W_lbm_per_ft2,rf,f,spl,nam,W,Wc)

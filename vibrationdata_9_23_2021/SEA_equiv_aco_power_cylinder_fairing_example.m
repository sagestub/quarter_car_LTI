function varargout = SEA_equiv_aco_power_cylinder_fairing_example(varargin)
% SEA_EQUIV_ACO_POWER_CYLINDER_FAIRING_EXAMPLE MATLAB code for SEA_equiv_aco_power_cylinder_fairing_example.fig
%      SEA_EQUIV_ACO_POWER_CYLINDER_FAIRING_EXAMPLE, by itself, creates a new SEA_EQUIV_ACO_POWER_CYLINDER_FAIRING_EXAMPLE or raises the existing
%      singleton*.
%
%      H = SEA_EQUIV_ACO_POWER_CYLINDER_FAIRING_EXAMPLE returns the handle to a new SEA_EQUIV_ACO_POWER_CYLINDER_FAIRING_EXAMPLE or the handle to
%      the existing singleton*.
%
%      SEA_EQUIV_ACO_POWER_CYLINDER_FAIRING_EXAMPLE('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in SEA_EQUIV_ACO_POWER_CYLINDER_FAIRING_EXAMPLE.M with the given input arguments.
%
%      SEA_EQUIV_ACO_POWER_CYLINDER_FAIRING_EXAMPLE('Property','Value',...) creates a new SEA_EQUIV_ACO_POWER_CYLINDER_FAIRING_EXAMPLE or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before SEA_equiv_aco_power_cylinder_fairing_example_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to SEA_equiv_aco_power_cylinder_fairing_example_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help SEA_equiv_aco_power_cylinder_fairing_example

% Last Modified by GUIDE v2.5 21-May-2016 14:47:35

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @SEA_equiv_aco_power_cylinder_fairing_example_OpeningFcn, ...
                   'gui_OutputFcn',  @SEA_equiv_aco_power_cylinder_fairing_example_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before SEA_equiv_aco_power_cylinder_fairing_example is made visible.
function SEA_equiv_aco_power_cylinder_fairing_example_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to SEA_equiv_aco_power_cylinder_fairing_example (see VARARGIN)

% Choose default command line output for SEA_equiv_aco_power_cylinder_fairing_example
...
% UIWAIT makes SEA_equiv_aco_power_cylinder_fairing_example wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = SEA_equiv_aco_power_cylinder_fairing_example_OutputFcn(hObject, eventdata, handles) 
...
delete(SEA_equiv_aco_power_cylinder_fairing_example);

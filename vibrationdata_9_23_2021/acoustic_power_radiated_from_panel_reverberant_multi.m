function varargout = acoustic_power_radiated_from_panel_reverberant_multi(varargin)
% ACOUSTIC_POWER_RADIATED_FROM_PANEL_REVERBERANT_MULTI MATLAB code for acoustic_power_radiated_from_panel_reverberant_multi.fig
%      ACOUSTIC_POWER_RADIATED_FROM_PANEL_REVERBERANT_MULTI, by itself, creates a new ACOUSTIC_POWER_RADIATED_FROM_PANEL_REVERBERANT_MULTI or raises the existing
%      singleton*.
%
%      H = ACOUSTIC_POWER_RADIATED_FROM_PANEL_REVERBERANT_MULTI returns the handle to a new ACOUSTIC_POWER_RADIATED_FROM_PANEL_REVERBERANT_MULTI or the handle to
%      the existing singleton*.
%
%      ACOUSTIC_POWER_RADIATED_FROM_PANEL_REVERBERANT_MULTI('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in ACOUSTIC_POWER_RADIATED_FROM_PANEL_REVERBERANT_MULTI.M with the given input arguments.
%
%      ACOUSTIC_POWER_RADIATED_FROM_PANEL_REVERBERANT_MULTI('Property','Value',...) creates a new ACOUSTIC_POWER_RADIATED_FROM_PANEL_REVERBERANT_MULTI or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before acoustic_power_radiated_from_panel_reverberant_multi_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to acoustic_power_radiated_from_panel_reverberant_multi_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help acoustic_power_radiated_from_panel_reverberant_multi

% Last Modified by GUIDE v2.5 15-Jan-2016 13:14:20

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @acoustic_power_radiated_from_panel_reverberant_multi_OpeningFcn, ...
                   'gui_OutputFcn',  @acoustic_power_radiated_from_panel_reverberant_multi_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before acoustic_power_radiated_from_panel_reverberant_multi is made visible.
function acoustic_power_radiated_from_panel_reverberant_multi_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to acoustic_power_radiated_from_panel_reverberant_multi (see VARARGIN)

% Choose default command line output for acoustic_power_radiated_from_panel_reverberant_multi
...
% UIWAIT makes acoustic_power_radiated_from_panel_reverberant_multi wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = acoustic_power_radiated_from_panel_reverberant_multi_OutputFcn(hObject, eventdata, handles) 
...
delete(acoustic_power_radiated_from_panel_reverberant_multi);
...
for i=1:NL
    ...
    p_dp(i)= rho_g*force(i)^2/(tpi*c*rho_s^2); 
    ...
    p_rad(i)=(rho_g*c)*(L*W)*v1(i)^2*rad_eff(i);   
...
% handles    structure with handles and user data (see GUIDATA)
     ...
     A = imread('radiated_thin_panel_reverberant.jpg');
     figure(999) 
     imshow(A,'border','tight','InitialMagnification',100)     

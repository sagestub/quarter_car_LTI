%
%  circular_plate_th_plot.m  ver 1.0  October 1, 2012
%
function[acc,rel_disp,fig_num]=circular_plate_th_plot(t,acc,rel_disp,...
                             abase,nodex,nodey,con_dof,num_con_dof,fig_num)
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
%
...
while(1)
%
    [plot_dof,sn]=find_circular_plot_node(nodex,nodey);
%
    figure(fig_num)
    fig_num=fig_num+1;
%

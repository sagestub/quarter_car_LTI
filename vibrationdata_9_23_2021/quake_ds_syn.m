...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%    
%
	disp(' quake_ds_syn.m    ver 1.0    March 30, 2011 ');
	disp(' by Tom Irvine');
...
%		disp('  Calculating damped sine parameters.');
		[amp,phase,delay,dampt,sss]=quake_DSS_sintime(ns,dt,dur,tpi,ia,iamax,ra,omega,last,syn_error,best_amp,best_phase,best_delay,best_dampt);
%
...
%            
			[xmin,xmax]=DSS_srs(FMAX,last,ns,freq,damp,dt,sum);
%            
            [syn_error,syn_ierror,iflag]=quake_DSS_srs_error(last,xmax,xmin,ra,iflag);
%
            if(iflag==1)
                disp(' ref 2 ');    
                break;
...
%
    disp(' ref 1');
    [x1r,x2r,x3r,x4r]=DSS_wgen(num2,t,residual,duration,sr,x1r,x2r,x3r,x4r,fl,fu,nt,ie,ffmin,ffmax);
    disp(' ref 2');
%            
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%

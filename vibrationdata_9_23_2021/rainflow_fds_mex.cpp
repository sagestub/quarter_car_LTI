...
//   rainflow_fds_mex.cpp  ver 1.5  July 7, 2014
...
void rainflow_fds_cpp(double *L,double *C,double *AverageAmp,double *MaxAmp,
                      double *AverageMean,double *MinValley,double *MaxPeak,
                      double *D,double *y,double *dchoice,double *exponent,size_t num)
{
...
//    mexPrintf(" mexFunction \n");
    ...
    AverageMean = mxGetPr(plhs[4]);
    MinValley   = mxGetPr(plhs[5]);
    MaxPeak     = mxGetPr(plhs[6]);
    D           = mxGetPr(plhs[7]);
    ...
    /* Call the rainflow_fds_cpp function. */
//    mexPrintf(" Call the rainflow_fds_cpp function \n");

    rainflow_fds_cpp(L,C,AverageAmp,MaxAmp,AverageMean,MinValley,MaxPeak,D,y,dchoice,exponent,num);
}

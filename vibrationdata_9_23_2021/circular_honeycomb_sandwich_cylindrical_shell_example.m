function varargout = circular_honeycomb_sandwich_cylindrical_shell_example(varargin)
% CIRCULAR_HONEYCOMB_SANDWICH_CYLINDRICAL_SHELL_EXAMPLE MATLAB code for circular_honeycomb_sandwich_cylindrical_shell_example.fig
%      CIRCULAR_HONEYCOMB_SANDWICH_CYLINDRICAL_SHELL_EXAMPLE, by itself, creates a new CIRCULAR_HONEYCOMB_SANDWICH_CYLINDRICAL_SHELL_EXAMPLE or raises the existing
%      singleton*.
%
%      H = CIRCULAR_HONEYCOMB_SANDWICH_CYLINDRICAL_SHELL_EXAMPLE returns the handle to a new CIRCULAR_HONEYCOMB_SANDWICH_CYLINDRICAL_SHELL_EXAMPLE or the handle to
%      the existing singleton*.
%
%      CIRCULAR_HONEYCOMB_SANDWICH_CYLINDRICAL_SHELL_EXAMPLE('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in CIRCULAR_HONEYCOMB_SANDWICH_CYLINDRICAL_SHELL_EXAMPLE.M with the given input arguments.
%
%      CIRCULAR_HONEYCOMB_SANDWICH_CYLINDRICAL_SHELL_EXAMPLE('Property','Value',...) creates a new CIRCULAR_HONEYCOMB_SANDWICH_CYLINDRICAL_SHELL_EXAMPLE or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before circular_honeycomb_sandwich_cylindrical_shell_example_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to circular_honeycomb_sandwich_cylindrical_shell_example_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help circular_honeycomb_sandwich_cylindrical_shell_example

% Last Modified by GUIDE v2.5 26-May-2016 15:04:58

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @circular_honeycomb_sandwich_cylindrical_shell_example_OpeningFcn, ...
                   'gui_OutputFcn',  @circular_honeycomb_sandwich_cylindrical_shell_example_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before circular_honeycomb_sandwich_cylindrical_shell_example is made visible.
function circular_honeycomb_sandwich_cylindrical_shell_example_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to circular_honeycomb_sandwich_cylindrical_shell_example (see VARARGIN)

% Choose default command line output for circular_honeycomb_sandwich_cylindrical_shell_example
...
diam=getappdata(0,'circular_shelf_diam');
if(isempty(diam)==0)
    ss=sprintf('%g',diam);
...
% UIWAIT makes circular_honeycomb_sandwich_cylindrical_shell_example wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = circular_honeycomb_sandwich_cylindrical_shell_example_OutputFcn(hObject, eventdata, handles) 
...
setappdata(0,'circular_shelf_diam',diam);

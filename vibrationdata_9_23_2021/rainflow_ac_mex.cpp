...
//   rainflow_mex_ac.cpp  ver 1.6  July 30, 2014
...
void rainflow_ac_cpp(double *L,double *C,double *AverageAmp,double *MaxAmp,
...
//    mexPrintf(" Call the rainflow_cpp function \n");
    ...
    rainflow_ac_cpp(L,C,AverageAmp,MaxAmp,MinMean,AverageMean,MaxMean,MinValley,MaxPeak,D,ac1,ac2,cL,y,dchoice,exponent,num);
}

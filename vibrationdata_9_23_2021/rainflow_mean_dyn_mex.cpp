...
//   rainflow_mean_dyn_mex.cpp  ver 1.0  by Tom Irvine
...
void rainflow_cpp(vector<float> &tac1, vector<float> &tac2, vector<float> &tamean, double *y, size_t num)
{
...
//*************************************************************************
    ...
    rainflow_cpp(tac1,tac2,tamean,y,num);

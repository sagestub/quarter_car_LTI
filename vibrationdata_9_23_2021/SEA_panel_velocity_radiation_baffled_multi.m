function varargout = SEA_panel_velocity_radiation_baffled_multi(varargin)
% SEA_PANEL_VELOCITY_RADIATION_BAFFLED_MULTI MATLAB code for SEA_panel_velocity_radiation_baffled_multi.fig
%      SEA_PANEL_VELOCITY_RADIATION_BAFFLED_MULTI, by itself, creates a new SEA_PANEL_VELOCITY_RADIATION_BAFFLED_MULTI or raises the existing
%      singleton*.
%
%      H = SEA_PANEL_VELOCITY_RADIATION_BAFFLED_MULTI returns the handle to a new SEA_PANEL_VELOCITY_RADIATION_BAFFLED_MULTI or the handle to
%      the existing singleton*.
%
%      SEA_PANEL_VELOCITY_RADIATION_BAFFLED_MULTI('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in SEA_PANEL_VELOCITY_RADIATION_BAFFLED_MULTI.M with the given input arguments.
%
%      SEA_PANEL_VELOCITY_RADIATION_BAFFLED_MULTI('Property','Value',...) creates a new SEA_PANEL_VELOCITY_RADIATION_BAFFLED_MULTI or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before SEA_panel_velocity_radiation_baffled_multi_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to SEA_panel_velocity_radiation_baffled_multi_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help SEA_panel_velocity_radiation_baffled_multi

% Last Modified by GUIDE v2.5 15-Jan-2016 15:30:43

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @SEA_panel_velocity_radiation_baffled_multi_OpeningFcn, ...
                   'gui_OutputFcn',  @SEA_panel_velocity_radiation_baffled_multi_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before SEA_panel_velocity_radiation_baffled_multi is made visible.
function SEA_panel_velocity_radiation_baffled_multi_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to SEA_panel_velocity_radiation_baffled_multi (see VARARGIN)

% Choose default command line output for SEA_panel_velocity_radiation_baffled_multi
...
% UIWAIT makes SEA_panel_velocity_radiation_baffled_multi wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = SEA_panel_velocity_radiation_baffled_multi_OutputFcn(hObject, eventdata, handles) 
...
delete(SEA_panel_velocity_radiation_baffled_multi);
...
for i=1:NL
    ...
    if(ns==1) % thin
        [rad_eff(i)]=re_thin_plate_bc(freq,fcr,a,b,c,bc);
    end
    if(ns==2)  % thick
        h=thick;

        [rad_eff(i)]=re_thick_plate_bending_shear(freq,fcr,a,b,c,em,md,mu,h);        
    end    
    power(i)=rho_c*Ap*rad_eff(i)*v(i)^2;
...
figure(996),imshow(A,'border','tight','InitialMagnification',100) 

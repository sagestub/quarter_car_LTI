function varargout = annular_honeycomb_sandwich_fairing_example(varargin)
% ANNULAR_HONEYCOMB_SANDWICH_FAIRING_EXAMPLE MATLAB code for annular_honeycomb_sandwich_fairing_example.fig
%      ANNULAR_HONEYCOMB_SANDWICH_FAIRING_EXAMPLE, by itself, creates a new ANNULAR_HONEYCOMB_SANDWICH_FAIRING_EXAMPLE or raises the existing
%      singleton*.
%
%      H = ANNULAR_HONEYCOMB_SANDWICH_FAIRING_EXAMPLE returns the handle to a new ANNULAR_HONEYCOMB_SANDWICH_FAIRING_EXAMPLE or the handle to
%      the existing singleton*.
%
%      ANNULAR_HONEYCOMB_SANDWICH_FAIRING_EXAMPLE('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in ANNULAR_HONEYCOMB_SANDWICH_FAIRING_EXAMPLE.M with the given input arguments.
%
%      ANNULAR_HONEYCOMB_SANDWICH_FAIRING_EXAMPLE('Property','Value',...) creates a new ANNULAR_HONEYCOMB_SANDWICH_FAIRING_EXAMPLE or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before annular_honeycomb_sandwich_fairing_example_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to annular_honeycomb_sandwich_fairing_example_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help annular_honeycomb_sandwich_fairing_example

% Last Modified by GUIDE v2.5 23-May-2016 15:51:35

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @annular_honeycomb_sandwich_fairing_example_OpeningFcn, ...
                   'gui_OutputFcn',  @annular_honeycomb_sandwich_fairing_example_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before annular_honeycomb_sandwich_fairing_example is made visible.
function annular_honeycomb_sandwich_fairing_example_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to annular_honeycomb_sandwich_fairing_example (see VARARGIN)

% Choose default command line output for annular_honeycomb_sandwich_fairing_example
...
% UIWAIT makes annular_honeycomb_sandwich_fairing_example wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = annular_honeycomb_sandwich_fairing_example_OutputFcn(hObject, eventdata, handles) 
...
delete(annular_honeycomb_sandwich_fairing_example);
...
[fcr,mpa,kflag]=honeycomb_sandwich_critical_frequency(E,G,v,tf,hc,rhof,rhoc,c,NSM_per_area);


[L,W]=convert_area_LW(Ap);

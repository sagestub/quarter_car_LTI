%
%   srs_tripartite_function.m   ver 2.2   June 28, 2013
%
function[fig_num]=srs_tripartite_function(iunit,fig_num,fn,pv_pos,pv_neg,Q)
%
%    
    n=length(fn);
%
...
%        
        pseudo_velocity_pn=[fn,pv_pos,abs(pv_neg)];

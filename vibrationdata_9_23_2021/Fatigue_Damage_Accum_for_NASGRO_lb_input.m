function varargout = Fatigue_Damage_Accum_for_NASGRO_lb_input(varargin)
% FATIGUE_DAMAGE_ACCUM_FOR_NASGRO_LB_INPUT MATLAB code for Fatigue_Damage_Accum_for_NASGRO_lb_input.fig
%      FATIGUE_DAMAGE_ACCUM_FOR_NASGRO_LB_INPUT, by itself, creates a new FATIGUE_DAMAGE_ACCUM_FOR_NASGRO_LB_INPUT or raises the existing
%      singleton*.
%
%      H = FATIGUE_DAMAGE_ACCUM_FOR_NASGRO_LB_INPUT returns the handle to a new FATIGUE_DAMAGE_ACCUM_FOR_NASGRO_LB_INPUT or the handle to
%      the existing singleton*.
%
%      FATIGUE_DAMAGE_ACCUM_FOR_NASGRO_LB_INPUT('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in FATIGUE_DAMAGE_ACCUM_FOR_NASGRO_LB_INPUT.M with the given input arguments.
%
%      FATIGUE_DAMAGE_ACCUM_FOR_NASGRO_LB_INPUT('Property','Value',...) creates a new FATIGUE_DAMAGE_ACCUM_FOR_NASGRO_LB_INPUT or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before Fatigue_Damage_Accum_for_NASGRO_lb_input_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to Fatigue_Damage_Accum_for_NASGRO_lb_input_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help Fatigue_Damage_Accum_for_NASGRO_lb_input

% Last Modified by GUIDE v2.5 18-Aug-2016 10:04:06

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @Fatigue_Damage_Accum_for_NASGRO_lb_input_OpeningFcn, ...
                   'gui_OutputFcn',  @Fatigue_Damage_Accum_for_NASGRO_lb_input_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before Fatigue_Damage_Accum_for_NASGRO_lb_input is made visible.
function Fatigue_Damage_Accum_for_NASGRO_lb_input_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to Fatigue_Damage_Accum_for_NASGRO_lb_input (see VARARGIN)

% Choose default command line output for Fatigue_Damage_Accum_for_NASGRO_lb_input
...
% UIWAIT makes Fatigue_Damage_Accum_for_NASGRO_lb_input wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = Fatigue_Damage_Accum_for_NASGRO_lb_input_OutputFcn(hObject, eventdata, handles) 
...
for i=1:kv
    ...
    knock=str2num(get(handles.edit_knock,'String'));
...
disp(' ');
out1=sprintf(' C with knock down factor = %8.4g',C);
disp(out1);
...
function edit_knock_Callback(hObject, eventdata, handles)
% hObject    handle to edit_knock (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of edit_knock as text
%        str2double(get(hObject,'String')) returns contents of edit_knock as a double


% --- Executes during object creation, after setting all properties.
function edit_knock_CreateFcn(hObject, eventdata, handles)
% hObject    handle to edit_knock (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called

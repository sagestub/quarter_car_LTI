function varargout = USA_VRS_v1(varargin)
% USA_VRS_v1 MATLAB code for USA_VRS_v1.fig
%      USA_VRS_v1, by itself, creates a new USA_VRS_v1 or raises the existing
%      singleton*.
%
%      H = USA_VRS_v1 returns the handle to a new USA_VRS_v1 or the handle to
%      the existing singleton*.
%
%      USA_VRS_v1('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in USA_VRS_v1.M with the given input arguments.
%
%      USA_VRS_v1('Property','Value',...) creates a new USA_VRS_v1 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before USA_VRS_v1_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to USA_VRS_v1_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help USA_VRS_v1

% Last Modified by GUIDE v2.5 21-Oct-2017 09:33:30

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @USA_VRS_v1_OpeningFcn, ...
                   'gui_OutputFcn',  @USA_VRS_v1_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before USA_VRS_v1 is made visible.
function USA_VRS_v1_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to USA_VRS_v1 (see VARARGIN)

% Choose default command line output for USA_VRS_v1
...
% UIWAIT makes USA_VRS_v1 wait for user response (see UIRESUME)
...
function varargout = USA_VRS_v1_OutputFcn(hObject, eventdata, handles) 
...
z=get(handles.listbox_zone,'Value');
...
if(z==1)
    setappdata(0,'psd_in',mpe1);
end
if(z==2)
    setappdata(0,'psd_in',mpe2);       
end
if(z==3)
    setappdata(0,'psd_in',mpe3);    
end
if(z==4)
    setappdata(0,'psd_in',mpe4);    
end
...
if(np==1)
    ...
    t_string=sprintf('PSD  %s  fn=%g Hz   Q=%g ',zs,fn,Q);
%
    figure(1);
    plot(fi,ai,fi,b)

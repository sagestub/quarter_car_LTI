%
%   enforced_partition_matrices.m  ver 1.2  May 13, 2015
%
%  etype =1  enforced acceleration
%         2  enforced displacement
%
%
function[TT,T1,T2,Mwd,Mww,Kwd,Kww,Mff,Mfd]=...
                 enforced_partition_matrices_MK(num,ea,mass,stiff,etype,dtype)
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%

function varargout = beam_springs(varargin)
% BEAM_SPRINGS MATLAB code for beam_springs.fig
%      BEAM_SPRINGS, by itself, creates a new BEAM_SPRINGS or raises the existing
%      singleton*.
%
%      H = BEAM_SPRINGS returns the handle to a new BEAM_SPRINGS or the handle to
%      the existing singleton*.
%
%      BEAM_SPRINGS('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in BEAM_SPRINGS.M with the given input arguments.
%
%      BEAM_SPRINGS('Property','Value',...) creates a new BEAM_SPRINGS or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before beam_springs_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to beam_springs_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help beam_springs

% Last Modified by GUIDE v2.5 29-Jul-2015 16:45:56

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @beam_springs_OpeningFcn, ...
                   'gui_OutputFcn',  @beam_springs_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before beam_springs is made visible.
function beam_springs_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to beam_springs (see VARARGIN)

% Choose default command line output for beam_springs
handles.output = hObject;

set(handles.listbox_ne,'Value',4);
...
fstr='beam_springs.png';

bg = imread(fstr);
info = imfinfo(fstr);
w = info.Width;  %An integer indicating the width of the image in pixels
h = info.Height; %An integer indicating the height of the image in 
...
% UIWAIT makes beam_springs wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = beam_springs_OutputFcn(hObject, eventdata, handles) 
...
setappdata(0,'fn',fn(1:NN));
setappdata(0,'ModeShapes',ModeShapes(:,1:NN));
...
if(handles.unit==1)
    ...
    set(handles.text_k1,'String','lbf/in'); 
    set(handles.text_k2,'String','lbf/in');   
    ...
    set(handles.text_k1,'String','N/mm'); 
    set(handles.text_k2,'String','N/mm');   
...
figure(fig_num);
plot(x,y,'b',xa,ya,'b',xb,yb,'b',xd,yd,'-.');

function varargout = SEA_equivalent_acoustic_power_cylinder(varargin)
% SEA_EQUIVALENT_ACOUSTIC_POWER_CYLINDER MATLAB code for SEA_equivalent_acoustic_power_cylinder.fig
%      SEA_EQUIVALENT_ACOUSTIC_POWER_CYLINDER, by itself, creates a new SEA_EQUIVALENT_ACOUSTIC_POWER_CYLINDER or raises the existing
%      singleton*.
%
%      H = SEA_EQUIVALENT_ACOUSTIC_POWER_CYLINDER returns the handle to a new SEA_EQUIVALENT_ACOUSTIC_POWER_CYLINDER or the handle to
%      the existing singleton*.
%
%      SEA_EQUIVALENT_ACOUSTIC_POWER_CYLINDER('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in SEA_EQUIVALENT_ACOUSTIC_POWER_CYLINDER.M with the given input arguments.
%
%      SEA_EQUIVALENT_ACOUSTIC_POWER_CYLINDER('Property','Value',...) creates a new SEA_EQUIVALENT_ACOUSTIC_POWER_CYLINDER or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before SEA_equivalent_acoustic_power_cylinder_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to SEA_equivalent_acoustic_power_cylinder_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help SEA_equivalent_acoustic_power_cylinder

% Last Modified by GUIDE v2.5 12-Jan-2016 17:22:50

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @SEA_equivalent_acoustic_power_cylinder_OpeningFcn, ...
                   'gui_OutputFcn',  @SEA_equivalent_acoustic_power_cylinder_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before SEA_equivalent_acoustic_power_cylinder is made visible.
function SEA_equivalent_acoustic_power_cylinder_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to SEA_equivalent_acoustic_power_cylinder (see VARARGIN)

% Choose default command line output for SEA_equivalent_acoustic_power_cylinder
...
% UIWAIT makes SEA_equivalent_acoustic_power_cylinder wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = SEA_equivalent_acoustic_power_cylinder_OutputFcn(hObject, eventdata, handles) 
...
delete(SEA_equivalent_acoustic_power_cylinder);

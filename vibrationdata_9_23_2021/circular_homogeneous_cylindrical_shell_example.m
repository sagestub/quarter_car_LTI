function varargout = circular_homogeneous_cylindrical_shell_example(varargin)
% CIRCULAR_HOMOGENEOUS_CYLINDRICAL_SHELL_EXAMPLE MATLAB code for circular_homogeneous_cylindrical_shell_example.fig
%      CIRCULAR_HOMOGENEOUS_CYLINDRICAL_SHELL_EXAMPLE, by itself, creates a new CIRCULAR_HOMOGENEOUS_CYLINDRICAL_SHELL_EXAMPLE or raises the existing
%      singleton*.
%
%      H = CIRCULAR_HOMOGENEOUS_CYLINDRICAL_SHELL_EXAMPLE returns the handle to a new CIRCULAR_HOMOGENEOUS_CYLINDRICAL_SHELL_EXAMPLE or the handle to
%      the existing singleton*.
%
%      CIRCULAR_HOMOGENEOUS_CYLINDRICAL_SHELL_EXAMPLE('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in CIRCULAR_HOMOGENEOUS_CYLINDRICAL_SHELL_EXAMPLE.M with the given input arguments.
%
%      CIRCULAR_HOMOGENEOUS_CYLINDRICAL_SHELL_EXAMPLE('Property','Value',...) creates a new CIRCULAR_HOMOGENEOUS_CYLINDRICAL_SHELL_EXAMPLE or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before circular_homogeneous_cylindrical_shell_example_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to circular_homogeneous_cylindrical_shell_example_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help circular_homogeneous_cylindrical_shell_example

% Last Modified by GUIDE v2.5 02-Jun-2016 11:52:28

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @circular_homogeneous_cylindrical_shell_example_OpeningFcn, ...
                   'gui_OutputFcn',  @circular_homogeneous_cylindrical_shell_example_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before circular_homogeneous_cylindrical_shell_example is made visible.
function circular_homogeneous_cylindrical_shell_example_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to circular_homogeneous_cylindrical_shell_example (see VARARGIN)

% Choose default command line output for circular_homogeneous_cylindrical_shell_example
...
OD=getappdata(0,'circular_shelf_diam');
if(isempty(OD)==0)
    ss=sprintf('%g',OD);
...
function varargout = circular_homogeneous_cylindrical_shell_example_OutputFcn(hObject, eventdata, handles) 
...
delete(circular_homogeneous_cylindrical_shell_example)
...
setappdata(0,'circular_shelf_diam',diameter);
...
y_label='Loss Factor';
t_string='Loss Factor  Circular Plate';
ppp=[fc dlf];
...
y_label='Rad Eff';
t_string='Radiation Efficiency  Circular Plate';
ppp=[fc rad_eff];

%
%   mdof_base_half_sine.m  ver 1.0  September 27, 2012  
%
function[acc,rel_disp,abase,fig_num]=...
       mdof_base_half_sine(fn,damp,PF,ModeShapes,T1,T2,ngw,fig_num)
%
%
...
%
    out1=sprintf(' Acceleration  dof %d relative to Base',sn);    
    title(out1);
    ylabel('Accel(G) ');
    xlabel('Time(sec)');

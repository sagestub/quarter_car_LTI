function varargout = asdfdsafasdfsdasd(varargin)
% ASDFDSAFASDFSDASD MATLAB code for asdfdsafasdfsdasd.fig
%      ASDFDSAFASDFSDASD, by itself, creates a new ASDFDSAFASDFSDASD or raises the existing
%      singleton*.
%
%      H = ASDFDSAFASDFSDASD returns the handle to a new ASDFDSAFASDFSDASD or the handle to
%      the existing singleton*.
%
%      ASDFDSAFASDFSDASD('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in ASDFDSAFASDFSDASD.M with the given input arguments.
%
%      ASDFDSAFASDFSDASD('Property','Value',...) creates a new ASDFDSAFASDFSDASD or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before asdfdsafasdfsdasd_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to asdfdsafasdfsdasd_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help asdfdsafasdfsdasd

% Last Modified by GUIDE v2.5 18-Apr-2017 14:54:25

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @asdfdsafasdfsdasd_OpeningFcn, ...
                   'gui_OutputFcn',  @asdfdsafasdfsdasd_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before asdfdsafasdfsdasd is made visible.
function asdfdsafasdfsdasd_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to asdfdsafasdfsdasd (see VARARGIN)

% Choose default command line output for asdfdsafasdfsdasd
handles.output = hObject;

set(handles.uipanel_modal_damping,'Visible','off');

set(handles.pushbutton_pf_FRF,'Visible','off');
set(handles.pushbutton_uft,'Visible','off');
...
% UIWAIT makes asdfdsafasdfsdasd wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = asdfdsafasdfsdasd_OutputFcn(hObject, eventdata, handles) 
...
set(handles.pushbutton_pf_FRF,'Visible','on');
set(handles.pushbutton_uft,'Visible','on');
...
% --- Executes on button press in pushbutton_pf_FRF.
function pushbutton_pf_FRF_Callback(hObject, eventdata, handles)
% hObject    handle to pushbutton_pf_FRF (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
...
% --- Executes on button press in pushbutton_uft.
function pushbutton_uft_Callback(hObject, eventdata, handles)
% hObject    handle to pushbutton_uft (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

function varargout = clf_L_Beam_single(varargin)
% CLF_L_BEAM_SINGLE MATLAB code for clf_L_Beam_single.fig
%      CLF_L_BEAM_SINGLE, by itself, creates a new CLF_L_BEAM_SINGLE or raises the existing
%      singleton*.
%
%      H = CLF_L_BEAM_SINGLE returns the handle to a new CLF_L_BEAM_SINGLE or the handle to
%      the existing singleton*.
%
%      CLF_L_BEAM_SINGLE('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in CLF_L_BEAM_SINGLE.M with the given input arguments.
%
%      CLF_L_BEAM_SINGLE('Property','Value',...) creates a new CLF_L_BEAM_SINGLE or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before clf_L_Beam_single_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to clf_L_Beam_single_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help clf_L_Beam_single

% Last Modified by GUIDE v2.5 30-Dec-2015 09:08:41

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @clf_L_Beam_single_OpeningFcn, ...
                   'gui_OutputFcn',  @clf_L_Beam_single_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before clf_L_Beam_single is made visible.
function clf_L_Beam_single_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to clf_L_Beam_single (see VARARGIN)

% Choose default command line output for clf_L_Beam_single
...
% UIWAIT makes clf_L_Beam_single wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = clf_L_Beam_single_OutputFcn(hObject, eventdata, handles) 
...
cl=sqrt(em/md);
    ...
    out2=sprintf('clf_bb = %8.4g',clf_bb);
    out3=sprintf('clf_bl = %8.4g',clf_bl);
    out4=sprintf('clf_ll = %8.4g \n',clf_ll);   

function varargout = critical_frequency_sandwich_cylinder(varargin)
% CRITICAL_FREQUENCY_SANDWICH_CYLINDER MATLAB code for critical_frequency_sandwich_cylinder.fig
%      CRITICAL_FREQUENCY_SANDWICH_CYLINDER, by itself, creates a new CRITICAL_FREQUENCY_SANDWICH_CYLINDER or raises the existing
%      singleton*.
%
%      H = CRITICAL_FREQUENCY_SANDWICH_CYLINDER returns the handle to a new CRITICAL_FREQUENCY_SANDWICH_CYLINDER or the handle to
%      the existing singleton*.
%
%      CRITICAL_FREQUENCY_SANDWICH_CYLINDER('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in CRITICAL_FREQUENCY_SANDWICH_CYLINDER.M with the given input arguments.
%
%      CRITICAL_FREQUENCY_SANDWICH_CYLINDER('Property','Value',...) creates a new CRITICAL_FREQUENCY_SANDWICH_CYLINDER or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before critical_frequency_sandwich_cylinder_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to critical_frequency_sandwich_cylinder_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help critical_frequency_sandwich_cylinder

% Last Modified by GUIDE v2.5 19-Jan-2016 11:33:40

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @critical_frequency_sandwich_cylinder_OpeningFcn, ...
                   'gui_OutputFcn',  @critical_frequency_sandwich_cylinder_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before critical_frequency_sandwich_cylinder is made visible.
function critical_frequency_sandwich_cylinder_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to critical_frequency_sandwich_cylinder (see VARARGIN)

% Choose default command line output for critical_frequency_sandwich_cylinder
...
% UIWAIT makes critical_frequency_sandwich_cylinder wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = critical_frequency_sandwich_cylinder_OutputFcn(hObject, eventdata, handles) 
...
delete(critical_frequency_sandwich_cylinder);
...
[fcr,rho,~,~,~,kflag]=cylinder_sandwich_fcr(md,md_core,tf,h,em,mu,G,c);
...
% honeycomb sandwich
    ...
    if(iu==1)
       out1=sprintf(' mass/area = %8.4g lbm/in^2 ',rho*386); 
    else
       out1=sprintf(' mass/area = %8.4g kg/m^2 ',rho);         
    end    
...
set(handles.edit_fcr,'String',ss);
...
if(iu==1)
        ...
        set(handles.text_md_core,'String','Mass Density (lbm/in^3)');     
else
        ...
        set(handles.text_md_core,'String','Mass Density (kg/m^3)');        
end
    
set(handles.uipanel_fsp,'Visible','on');
...
A = imread('sandwich_cylinder_fcr.jpg');      

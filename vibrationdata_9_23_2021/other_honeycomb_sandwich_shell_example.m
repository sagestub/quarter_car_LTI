function varargout = other_honeycomb_sandwich_shell_example(varargin)
% OTHER_HONEYCOMB_SANDWICH_SHELL_EXAMPLE MATLAB code for other_honeycomb_sandwich_shell_example.fig
%      OTHER_HONEYCOMB_SANDWICH_SHELL_EXAMPLE, by itself, creates a new OTHER_HONEYCOMB_SANDWICH_SHELL_EXAMPLE or raises the existing
%      singleton*.
%
%      H = OTHER_HONEYCOMB_SANDWICH_SHELL_EXAMPLE returns the handle to a new OTHER_HONEYCOMB_SANDWICH_SHELL_EXAMPLE or the handle to
%      the existing singleton*.
%
%      OTHER_HONEYCOMB_SANDWICH_SHELL_EXAMPLE('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in OTHER_HONEYCOMB_SANDWICH_SHELL_EXAMPLE.M with the given input arguments.
%
%      OTHER_HONEYCOMB_SANDWICH_SHELL_EXAMPLE('Property','Value',...) creates a new OTHER_HONEYCOMB_SANDWICH_SHELL_EXAMPLE or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before other_honeycomb_sandwich_shell_example_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to other_honeycomb_sandwich_shell_example_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help other_honeycomb_sandwich_shell_example

% Last Modified by GUIDE v2.5 26-May-2016 18:50:58

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @other_honeycomb_sandwich_shell_example_OpeningFcn, ...
                   'gui_OutputFcn',  @other_honeycomb_sandwich_shell_example_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before other_honeycomb_sandwich_shell_example is made visible.
function other_honeycomb_sandwich_shell_example_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to other_honeycomb_sandwich_shell_example (see VARARGIN)

% Choose default command line output for other_honeycomb_sandwich_shell_example
handles.output = hObject;


if(isempty()==0)
    ss=sprintf('%g',);
    set(handles.,'String',ss);
end 
...
% UIWAIT makes other_honeycomb_sandwich_shell_example wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = other_honeycomb_sandwich_shell_example_OutputFcn(hObject, eventdata, handles) 
...
delete(circular_honeycomb_sandwich_shell_example);
